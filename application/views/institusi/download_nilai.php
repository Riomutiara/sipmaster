		<div class="container-fluid my-5">
			<div class="card shadow">
				...
				<!-- <input type="text" name="jadwal_username" id="jadwal_username"></input> -->
				...
				<div class="form-group">
					...
					<div class="table-responsive mb-5">
						<table class="table tabled-bordered table-hover table-sm" id="tabel_download_nilai" width="100%">
		    ...
		    <div class="modal-content">
		      ...
		      <form method="post" id="form_nilai">
				<div class="modal-body">
					...
					Status : <h4><i><span class="badge badge-info" id="nilai_status" 
		      	...
		      	<div class="modal-footer">
		      		...
		      		<input type="hidden" name="username_jadwal" id="username_jadwal">
					<!-- <button type="button" class="btn btn-success" id="download" target="_blank"><i class="fas fa-file-download mr-2"></i>Download Surat Pengantar</button> -->
	...
	// SelectPicker data jadwal
		...
		$.ajax({
    		...
    		// Datatables Jadwal
			dataTable = $('#tabel_download_nilai').DataTable({
			"info":false,
			"processing":true,  
	       	"serverSide":true,  
	       	"order":[], 
			"ajax":
				{  
				"url":"<?php echo base_url(); ?>institusi/dataNilai",  
				"type":"POST",        
				"data": function(data)
				{
			...
			// End approve jadwal
			$(document).on('click', '.download_nilai', function(){			
				var id = $(this).attr('id');
			...
			// 	$.ajax({
			// 		url: '<?php echo base_url(); ?>institusi/fetchSingleFileNilai',
			// 		method: 'POST',
			// 		data: {jadwal_id:jadwal_id},
			// 		dataType: 'JSON',
			// 		success:function(data)
